...
public Plugin myinfo = {
	name = "[BFG] WarMod - Robonyantame ver",
	author = "Versatile_BFG and Robonyantame",
...
public void OnPluginStart()
{
	...
	wm_max_players = CreateConVar("wm_max_players", "2", "Sets the maximum players allowed on both teams combined, others will be forced to spectator (0 = unlimited)", FCVAR_NOTIFY, true, 0.0);
